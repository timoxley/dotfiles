...
# this is slightly modified from https://github.com/thlorenz/dotfiles/blob/eb547d2b0ce976518c93e80957cdc9973c91b297/scripts/tweak-yosemite.sh
...
echo ""
echo "Requiring password a bit after sleep or screen saver begins"
defaults write com.apple.screensaver askForPassword -int 1
defaults write com.apple.screensaver askForPasswordDelay -int 100
...
echo ""
echo "Set Dock to auto-hide and speed up the auto-hiding delay? (y/n)"
read -r response
case $response in
  [yY])
